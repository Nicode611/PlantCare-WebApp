    ...
    return (
        <div className="w-full h-full flex md:flex-col justify-start md:justify-between items-center bg-[#e8e8e8] shadow-spread">
            <div className="flex h-12  md:flex-col items-center w-full">
                <div className="flex justify-start md:justify-center items-center h-full md:w-full ml-5 md:ml-0 md:mt-5 md:mb-10">
                ...
                <nav className="hidden md:flex flex-col items-start w-[100%]">
