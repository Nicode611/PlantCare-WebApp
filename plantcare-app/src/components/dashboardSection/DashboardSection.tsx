            ...
            <div className="w-full h-full flex flex-col justify-start items-center">
                ...
                <div className="flex flex-col lg:flex-row w-full h-auto lg:h-[70%] m-2 mr-0 ml-0">
                    ...
                    <div className="flex flex-col w-full lg:w-[60%] h-auto lg:h-full mt-2 mr-0 lg:mr-2 mb-2">
                        {/* Module des tâches */}
                        <div className="w-full h-[200px] lg:h-[30%] m-2 rounded-lg shadow-lg overflow-hidden">
                            <TasksModule/>
                        </div>
                        {/* Module de soin */}
                        <div className="w-full h-[300px] lg:h-[70%] m-2 rounded-lg shadow-lg overflow-hidden">
                            <CaringModule/>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col w-full lg:w-[40%] h-auto lg:h-full m-2">
                        {/* Module des plantes */}
                        <div className="w-full h-[250px] lg:h-[60%] m-2 rounded-lg shadow-lg overflow-hidden">
                            <PlantsModule/>
                        </div>
                        {/* Module du calendrier */}
                        <div className="w-full h-[200px] lg:h-[40%] m-2 rounded-lg shadow-lg overflow-hidden">
                            <CalendarModule></CalendarModule>
                        </div>
                    </div>
                </div>
                {/* Module des maladies */}
                <div className="w-full h-[250px] lg:h-[30%] justify-center m-2 rounded-lg shadow-lg overflow-hidden overflow-x-auto">
                    <DiseasesModule/>
                </div>
            </div>
        </section>
